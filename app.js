...
// http upon which can respond to
app.options('*', cors());
// app.options('/api/v1/tours/:id', cors()); // only complex request like post patch and delete of tours
...
app.use(
  helmet.contentSecurityPolicy({
    directives: {
      ...
      scriptSrc: ["'self'", 'https://unpkg.com/leaflet@1.9.4/dist/leaflet.js', 'https://js.stripe.com/v3/', 'http://www.w3.org/2000/*', 'unsafe-inline','unsafe-hashes'],
      objectSrc: ["'self'"],
